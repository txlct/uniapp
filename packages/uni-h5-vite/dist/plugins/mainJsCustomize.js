...
exports.uniMainJsCustomizePlugin = void 0;
const uni_cli_shared_1 = require("@dcloudio/uni-cli-shared");
const utils_1 = require("../utils");
function getGlobal(ssr) {
    return ssr ? 'global' : 'window';
}
function uniMainJsCustomizePlugin(uniOptions) {
    return (0, uni_cli_shared_1.defineUniMainJsPlugin)((opts) => {
        ...
        return {
            ...
            transform(code, id, options) {
                if (opts.filter(id)) {
                    const ssr = (0, utils_1.isSSR)(options);
...
exports.uniMainJsCustomizePlugin = uniMainJsCustomizePlugin;
function createSplitApp(code, globalName) {
    return `import { plugin as __plugin } from '@dcloudio/uni-h5';${code.replace('createSSRApp', 'createVueApp as createSSRApp')};const app = createApp().app;
  app.use(__plugin).mount("#app");

  `;
}
function createApp(code, globalName) {
    return `import { plugin as __plugin } from '@dcloudio/uni-h5';${code.replace('createSSRApp', 'createVueApp as createSSRApp')};const app = createApp().app; 
  app.use(__plugin).mount("#app");`;
}
...
//# sourceMappingURL=mainJsCustomize.js.map